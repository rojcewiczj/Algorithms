...
class Test(unittest.TestCase):
  def setUp_small(self):
    file_contents = open('c:/Users/rojce/documents/GitHub/Algorithms/knapsack/data/small1.txt', 'r')
    self.small_1_items = []
    ...
    file_contents = open('c:/Users/rojce/documents/GitHub/Algorithms/knapsack/data/small2.txt', 'r')
    self.small_2_items = []
  ...
  def setUp_medium(self):
    file_contents = open('c:/Users/rojce/documents/GitHub/Algorithms/knapsack/data/medium1.txt', 'r')
    self.medium_1_items = []
    ...
    file_contents = open('c:/Users/rojce/documents/GitHub/Algorithms/knapsack/data/medium2.txt', 'r')
    self.medium_2_items = []
    ...
    file_contents = open('c:/Users/rojce/documents/GitHub/Algorithms/knapsack/data/medium3.txt', 'r')
    self.medium_3_items = []
  ...
  def setUp_large(self):
    file_contents = open('c:/Users/rojce/documents/GitHub/Algorithms/knapsack/data/large1.txt', 'r')
    self.large_1_items = []
